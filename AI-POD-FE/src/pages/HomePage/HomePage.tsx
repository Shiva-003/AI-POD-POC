...
const Home = () => {
  ...
  const options = [
    { label: "Skin", path: "/skin-examination" },
    { label: "Eye", path: "/eye-examination" },
    { label: "Wound", path: "/wound-examination" },
  ];
    ...
    <div className="h-[calc(100%-81px)] flex flex-col items-center justify-center bg-white px-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 w-full max-w-5xl place-items-center">
        {options.map(({ label, path }) => (
          ...
          >
            <div className="w-20 h-20 text-blue-600 mb-5 group-hover:scale-110 transition-transform duration-200" />
