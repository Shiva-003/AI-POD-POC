    ...
    <>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
          <h2 className="text-2xl font-bold mb-6">Wound Examination</h2>

          <form onSubmit={onSubmit} className="space-y-5">
            {/* Step 1 */}
            <div>
              <label className="block font-medium mb-2">
                Step 1: Take or upload a photo of your wound
              </label>
        ...
        <div className="bg-gray-50 p-6 rounded-lg shadow-sm min-h-[300px]">
          {result ? (
            <>
              <h3 className="text-2xl font-bold mb-4">Wound Analysis Result</h3>
